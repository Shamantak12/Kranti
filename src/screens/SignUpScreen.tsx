          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            <LinearGradient colors={['#667eea', '#764ba2']} style={styles.headerGradient}>
              <View style={styles.headerContainer}>
                <Text style={styles.title}>Welcome to Kranti</Text>
            ...
            <View style={styles.plansContainer}>
              <Text style={styles.plansTitle}>Choose Your Path</Text>
              <Text style={styles.plansSubtitle}>Select the perfect plan for your spiritual journey</Text>
        ...
        <View style={styles.bottomButtonContainer}>
          <TouchableOpacity style={styles.startButton} onPress={handleSignUp}>
            ...
            >
              ...
              <Text style={styles.startButtonSubtext}>Begin with Kranti</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
